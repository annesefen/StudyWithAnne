...
document.addEventListener('DOMContentLoaded', () => {
  ...
  searchBar.addEventListener('input', (e) => {
    ...
    const flashcardData = {		'exam1': [
		...
		{"question": "Misfolded Proteins", "answer": "Can lead to diseases like Alzheimer’s, Parkinson’s, Huntington’s, and ALS.", "tags": ["#proteins", "#terminology", "#disease"]},
		...
		{"question": "Allosteric Negative Regulation", "answer": "A regulatory molecule binds and inactivates the enzyme.", "tags": ["#proteins", "#terminology", "#regulation"]},
		{"question": "Allosteric Positive Regulation", "answer": "A regulatory molecule binds and activates the enzyme.", "tags": ["#proteins", "#terminology", "#regulation"]},
